...
function App() {
  ...
  return (
    <div className={`App ${libraryStatus ? 'library-active' : ""}`}>
      ...
      <Player isPlaying={isPlaying} setIsPlaying={setIsPlaying} currentSong={currentSong} setSongs={setSongs} setCurrentSong={setCurrentSong} audioRef={audioRef} setSongInfo={setSongInfo} songInfo={songInfo} songs={songs}/>
